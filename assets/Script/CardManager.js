...
cc.Class({
    ...
    onLoad() { // 初始化相關操作
        ...
        global.socket.on("GetDealer", function(Info){

            self.UpdateDealer(Info);
        });

        global.socket.on("GetBet", function(Info){
            self.UpdateBet(Info);
        });
    ...
    UpdateDealer(Info){
        ...
        self.CardObj.currentStatus.PrePre.getComponent("PokerControl").showstatus("grab_0" + (Info.currentStatus.PrePre).toString());
        self.CardObj.currentStatus.Pre.getComponent("PokerControl").showstatus("grab_0" + (Info.currentStatus.Pre).toString());
        self.CardObj.currentStatus.Me.getComponent("PokerControl").showstatus("grab_0" + (Info.currentStatus.Me).toString());
        self.CardObj.currentStatus.Next.getComponent("PokerControl").showstatus("grab_0" + (Info.currentStatus.Next).toString());
        self.CardObj.currentStatus.NextNext.getComponent("PokerControl").showstatus("grab_0" + (Info.currentStatus.NextNext).toString());
    ...
    UpdateBet(Info){
        ...
        self.CardObj.currentStatus.PrePre.getComponent("PokerControl").showstatus("BetTest_" + (Info.currentStatus.PrePre).toString());
        self.CardObj.currentStatus.Pre.getComponent("PokerControl").showstatus("BetTest_" + (Info.currentStatus.Pre).toString());
        self.CardObj.currentStatus.Me.getComponent("PokerControl").showstatus("BetTest_" + (Info.currentStatus.Me).toString());
        self.CardObj.currentStatus.Next.getComponent("PokerControl").showstatus("BetTest_" + (Info.currentStatus.Next).toString());
        self.CardObj.currentStatus.NextNext.getComponent("PokerControl").showstatus("BetTest_" + (Info.currentStatus.NextNext).toString());
